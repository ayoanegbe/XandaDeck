using XandaDeck.Core.Extensions;
using System;
...
namespace XandaDeck.Core.Helpers
{
    public class CommonHelper 
    {
        ...
        /// <returns></returns>
        public static string EnsureEmailIsValid(string email)
        {
            ...
            {
                throw new GeneralException("Email is not valid.");
            }
        ...
        public static bool IsValidEmail(string email)
        {
            ...
            return result && DnsCheck.IsEmailValid(email);
        }
